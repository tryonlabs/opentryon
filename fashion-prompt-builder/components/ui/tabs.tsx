...
export function TabsList({
  ...
  return (
    <div
      className={cn(
        'inline-flex w-full h-auto sm:h-12 items-center justify-center rounded-xl bg-gradient-to-r from-neutral-50 via-white to-neutral-50 p-1 sm:p-1.5 shadow-sm border border-neutral-200',
        className
      )}
    >
      {children}
