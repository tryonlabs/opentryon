                ...
                <CardContent>
                  ...
                  {currentTemplate && (
                    <div className="bg-gradient-to-r from-primary-50 to-white p-4 rounded-lg border-l-4 border-primary-400">
                      <p className="text-neutral-700">{currentTemplate.description}</p>
                    </div>
                  )}
                </CardContent>
              </Card>
                    ...
                    <div className="space-y-6 pt-2">
                      ...
                      {(placeholders.includes('age') || placeholders.includes('gender')) && (
                        <div className="bg-gradient-to-br from-primary-50 to-white rounded-xl p-5 border border-primary-100">
                          <div className="flex items-center gap-2 mb-4">
                            ...
                            <h4 className="text-base font-semibold text-neutral-900">Basic Information</h4>
                          </div>
                      ...
                      {(placeholders.includes('pose') || placeholders.includes('outfit')) && (
                        <div className="bg-gradient-to-br from-neutral-50 to-white rounded-xl p-5 border border-neutral-200">
                          <div className="flex items-center gap-2 mb-4">
                            <div className="w-8 h-8 rounded-lg bg-neutral-600 flex items-center justify-center text-white font-semibold">
                              3
                            </div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="relative">
                      <Textarea
                        ...
                        className="font-mono text-sm bg-white border-2 border-neutral-200 focus:border-primary-400 transition-colors"
                      />
