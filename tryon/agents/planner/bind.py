...
_ALIASES: Tuple[Tuple[str, str, Optional[str]], ...] = (
    ...
    ("google-vton", "google-vton", "vton"),
    ("photoroom virtual model", "photoroom-virtual-model", "vton"),
    ("photoroom-virtual-model", "photoroom-virtual-model", "vton"),
    ("photoroom virtual try-on", "photoroom-vton", "vton"),
    ("photoroom-vton", "photoroom-vton", "vton"),
    ("photoroom try-on", "photoroom-vton", "vton"),
    ("photoroom vton", "photoroom-vton", "vton"),
    ("photoroom", "photoroom-vton", "vton"),
    ("outfitanyone-plus", "outfitanyone-plus", "vton"),
    ("outfit anyone plus", "outfitanyone-plus", "vton"),
    ("aitryon-plus", "outfitanyone-plus", "vton"),
    ("aitryon plus", "outfitanyone-plus", "vton"),
    ("outfitanyone", "outfitanyone-plus", "vton"),
    ("alibaba try-on", "outfitanyone-plus", "vton"),
    ("alibaba vton", "outfitanyone-plus", "vton"),
    ("catvton", "catvton", "vton"),
    ("cat vton", "catvton", "vton"),
    ("leffa", "leffa", "vton"),
    ...
    ("gpt-image-2.5-sunburst", "gpt-image-2.5-sunburst", None),
    ("gpt image 2.5 sunburst", "gpt-image-2.5-sunburst", None),
    ("chatgpt images 2.5 sunburst", "gpt-image-2.5-sunburst", None),
    ("images 2.5 sunburst", "gpt-image-2.5-sunburst", None),
    ("gpt-image-2.5-flare", "gpt-image-2.5", None),
    ("gpt image 2.5 flare", "gpt-image-2.5", None),
    ("chatgpt images 2.5", "gpt-image-2.5", None),
    ("chatgpt image 2.5", "gpt-image-2.5", None),
    ("gpt-image-2.5", "gpt-image-2.5", None),
    ("gpt image 2.5", "gpt-image-2.5", None),
    ("images 2.5", "gpt-image-2.5", None),
    ...
    ("p-video-2-pro", "p-video-2-pro", "video-generate"),
    ("p video 2 pro", "p-video-2-pro", "video-generate"),
    ("p-video 2 pro", "p-video-2-pro", "video-generate"),
    ("pruna video 2 pro", "p-video-2-pro", "video-generate"),
    ("pruna p-video-2-pro", "p-video-2-pro", "video-generate"),
    ("muse-image", "muse-image", None),
    ("muse image", "muse-image", None),
    ("meta muse", "muse-image", None),
    ("minimax-h3-local", "minimax-h3-local", "video-generate"),
    ("minimax h3 local", "minimax-h3-local", "video-generate"),
    ("fal-h3-max", "fal-h3-max", "video-generate"),
    ("fal h3 max", "fal-h3-max", "video-generate"),
    ("fal h3-max", "fal-h3-max", "video-generate"),
    ("h3-max fal", "fal-h3-max", "video-generate"),
    ("h3 max fal", "fal-h3-max", "video-generate"),
    ("fal-h3-max-lipsync", "fal-h3-max-lipsync", "video-generate"),
    ("fal h3 max lip sync", "fal-h3-max-lipsync", "video-generate"),
    ("h3-max lip-sync", "fal-h3-max-lipsync", "video-generate"),
    ("h3-max lip sync", "fal-h3-max-lipsync", "video-generate"),
    ("h3 max lip sync", "fal-h3-max-lipsync", "video-generate"),
    ("h3 max lipsync", "fal-h3-max-lipsync", "video-generate"),
    ("lip sync h3 max", "fal-h3-max-lipsync", "video-generate"),
    ("minimax lip sync", "fal-h3-max-lipsync", "video-generate"),
    ("minimax-h3-max", "minimax-h3-max", "video-generate"),
    ("minimax h3 max", "minimax-h3-max", "video-generate"),
    ("h3-max", "minimax-h3-max", "video-generate"),
    ("h3 max", "minimax-h3-max", "video-generate"),
    ("hailuo-h3-max", "minimax-h3-max", "video-generate"),
    ("hailuo h3 max", "minimax-h3-max", "video-generate"),
    ...
    ("seedance 2.5", "seedance", "video-generate"),
    ("seedance-2-5", "seedance", "video-generate"),
    ...
    ("nemotron omni", "nemotron-omni", "understand"),
    ("hy4-preview-local", "hy4-preview-local", "understand"),
    ("hy4 preview local", "hy4-preview-local", "understand"),
    ("hy4 local", "hy4-preview-local", "understand"),
    ("hy4-preview", "hy4-preview", "understand"),
    ("hy4 preview", "hy4-preview", "understand"),
    ("hunyuan 4", "hy4-preview", "understand"),
    ("tencent hy4", "hy4-preview", "understand"),
    ("hy4", "hy4-preview", "understand"),
    ("qwen3.8-max", "qwen3.8-max", "understand"),
    ("qwen 3.8 max", "qwen3.8-max", "understand"),
    ("qwen3.8-omni-flash", "qwen3.8-omni-flash", "understand"),
    ("qwen 3.8 omni flash", "qwen3.8-omni-flash", "understand"),
    ("qwen omni flash", "qwen3.8-omni-flash", "understand"),
    ("qwen omni", "qwen3.8-omni-flash", "understand"),
    ("qwen3.8", "qwen3.8", "understand"),
    ("glm-5.3-flashx", "glm-5.3-flashx", "understand"),
    ("glm 5.3 flashx", "glm-5.3-flashx", "understand"),
    ("glm flashx", "glm-5.3-flashx", "understand"),
    ("glm 5.3 flash x", "glm-5.3-flashx", "understand"),
    ("zhipu glm", "glm-5.3-flashx", "understand"),
    ("z.ai glm", "glm-5.3-flashx", "understand"),
    ("ternary-bonsai-2-27b", "ternary-bonsai-2-27b", "understand"),
    ("ternary bonsai 2 27b", "ternary-bonsai-2-27b", "understand"),
    ("ternary bonsai", "ternary-bonsai-2-27b", "understand"),
    ("bonsai 2 27b", "ternary-bonsai-2-27b", "understand"),
    ("prismml bonsai", "ternary-bonsai-2-27b", "understand"),
    ("bonsai", "ternary-bonsai-2-27b", "understand"),
