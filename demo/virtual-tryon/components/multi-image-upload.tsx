  ...
  if (layout === 'grid') {
    ...
    return (
      <div className="w-full">
        ...
        {description && (
          <p className="text-xs sm:text-sm text-neutral-500 mb-3 sm:mb-4">{description}</p>
        )}
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center space-y-1 sm:space-y-2 p-2 sm:p-4">
                ...
                {garmentImages.length > 0 && (
                  <p className="text-[10px] sm:text-xs text-neutral-400 mt-1 sm:mt-2">
        ...
        {!canAddMore && (
          <div className="text-center text-sm text-neutral-500 py-4 mt-4">
