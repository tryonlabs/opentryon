...
async def check_dry_run_calls() -> None:
    ...
    cases = [
        ...
        ("generate_gpt_image_2_5", {"prompt": "editorial still", "dry_run": True}, False),
        ("edit_gpt_image_2_5", {"images": ["a.jpg"], "prompt": "make it blue", "dry_run": True}, False),
        ("generate_gpt_image_2_5_sunburst", {"prompt": "editorial still", "dry_run": True}, False),
        ("edit_gpt_image_2_5_sunburst", {"images": ["a.jpg"], "prompt": "make it blue", "dry_run": True}, False),
        ...
        ("video_generate_fal_h3_max_lipsync", {"image": "p.jpg", "audio": "line.wav", "dry_run": True}, False),
